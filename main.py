from src.class_module import Category, Product, Smartphone, LawnGrass
...
if __name__ == '__main__':
    ...
    category_list1 = [smartphone1, smartphone2, smartphone3]
    ...
    #
    # try:
    #     invalid_sum = smartphone1 + smartphone3
    # except TypeError:
